...
function contextmenu(t){var e=document.getElementsByTagName("body")[0];if("true"!==e.getAttribute("data-css")){var n=document.createElement("style");n.type="text/css",n.setAttribute("data-conmenu-display","true"),n.innerHTML="@import url(https://fonts.googleapis.com/css?family=Roboto:400, 100, 100italic, 300, 300italic, 400italic, 500, 500italic, 700, 700italic, 900, 900italic&subset=latin, cyrillic-ext, vietnamese, cyrillic, greek-ext, greek, latin-ext); html, body {-webkit-user-select:none;-moz-user-select:none;-o-user-select:none;-ms-user-select:none;user-select:none;}header, section, footer, aside, nav, main, article, figure, data, wmx, code, file {display:block;}.contextmenu {background-color:#fff;position:absolute;box-shadow:0.3px 0.3px 0.3px #000;-moz-box-shadow:0.3px 0.3px 0.3px #000;-webkit-box-shadow:0.3px 0.3px 0.3px #000;border:1px #332E2E solid;cursor:default;}.contextmenu-layout {width:250px;font-family:'Roboto', sans-serif;list-style:none;}.contextmenu-layout li {width:84%;padding:6px 20px;color:#383333;}.contextmenu-layout li:hover {background-color:#1496F3;color:#fff;transition:all 0.3s ease;-o-transition:all 0.3s ease;-webkit-transition:all 0.3s ease;-ms-transition:all 0.3s ease;-moz-transition:all 0.3s ease;}",e.appendChild(n),e.setAttribute("data-css","true")}if(void 0!==t.elem){var u,o=document.querySelectorAll(t.elem);for(u=0;u<o.length;u++)o[u].innerHTML="<div class='contextmenu' data-elem='"+t.elem+"' data-author='Contextmenu.js'><div class='contextmenu-layout'></div></div>";contextmenu_obj(t)}else conError("Không có thẻ được chỉ định !")}function contextmenu_obj(t){var e=".contextmenu";if(void 0!==t.display){if(void 0!==t.display.name){var n,u=document.querySelectorAll(e);for(n=0;n<u.length;n++)u[n].setAttribute("data-display-name",t.display.name)}if(void 0!==t.display.url){var o,l=document.querySelectorAll(e);for(o=0;o<l.length;o++){l[o].setAttribute("data-display-url",t.display.url),document.querySelectorAll("link[data-conmenu-display=true]")[0].remove();var i=document.createElement("link");i.rel="stylesheet",i.setAttribute("data-conmenu-display","true"),i.href=t.display.url,document.getElementsByTagName("body")[0].appendChild(i)}}}void 0!==t.sub&&contextmenu_arr(t),void 0===t.sub&&conError("Không có sub được chỉ định !")}function contextmenu_arr(t){var e=t.sub.length;if(e>0){var n;for(n=0;e>n;n++){{e[n]}if(void 0===t.sub[n].text&&conError("Không có tên sub !"),void 0!==t.sub[n].text){var u=document.createElement("li");u.innerHTML=t.sub[n].text,u.setAttribute("data-ob","subtext"),u.setAttribute("title",t.sub[n].text),u.setAttribute("data-subtext",n),document.querySelectorAll(".contextmenu-layout")[0].appendChild(u),void 0!==t.sub[n].a&&(void 0!==t.sub[n].a.link&&document.querySelectorAll('.contextmenu-layout li[data-subtext="'+n+'"]')[0].setAttribute("onclick","window.open('"+t.sub[n].a.link+"');"),void 0!==t.sub[n].a.title&&document.querySelectorAll('.contextmenu-layout li[data-subtext="'+n+'"]')[0].setAttribute("title",t.sub[n].a.title)),void 0!==t.sub[n].id&&document.querySelectorAll('.contextmenu-layout li[data-subtext="'+n+'"]')[0].setAttribute("id",t.sub[n].id),void 0!==t.sub[n].id_&&document.querySelectorAll('.contextmenu-layout li[data-subtext="'+n+'"]')[0].setAttribute("id",t.sub[n].id_),void 0!==t.sub[n].class_&&document.querySelectorAll('.contextmenu-layout li[data-subtext="'+n+'"]')[0].setAttribute("class",t.sub[n].class_),void 0!==t.sub[n].title&&document.querySelectorAll('.contextmenu-layout li[data-subtext="'+n+'"]')[0].setAttribute("title",t.sub[n].title),void 0!==t.sub[n].img&&void 0!==t.sub[n].img.src&&document.querySelectorAll('.contextmenu-layout li[data-subtext="'+n+'"]')[0].setAttribute("style",'.contextmenu-layout li[data-subtext="'+n+'"] {background:url('+t.sub[n].img.src+");}"),void 0!==t.sub[n].menu&&(document.querySelectorAll('.contextmenu-layout li[data-subtext="'+n+'"]')[0].setAttribute("onmouseover","openSubmenu('data-subtext="+n+"');"),document.querySelectorAll("body")[0].setAttribute("onmouseover","closeSubmenu('data-subtext="+n+"');"))}}}else conError("Không có sub !")}function conError(t){console.log(t+'	- Contextmenu.js');}function openSubmenu(t){document.querySelectorAll(".contextmenu-layout li["+t+"] > .contextmenu")[0].style.display="block"}function closeSubmenu(t){document.querySelectorAll(".contextmenu-layout li["+t+"] > .contextmenu")[0].style.display="none"}window.oncontextmenu=function(t){if(t=t||window.oncontextmenu,x=t.clientX,y=t.clientY,t){var e=document.querySelectorAll(".contextmenu")[0].style;return e.display="block",e.marginTop=y+"px",e.marginLeft=x+"px",!1}},window.onclick=function(t){t=t||window.onclick,t&&setTimeout(function(){document.querySelectorAll(".contextmenu")[0].style.display="none"},80)};
